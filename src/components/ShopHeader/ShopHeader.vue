  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="showBrief = !showBrief">
    ...
    <div class="shop-header-discounts" @click="showActivity = !showActivity" v-if="info.supports">
      <div class="discounts-left">
        <div class="activity" :class="activeColor[info.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">{{info.supports.length? info.supports[0].name : ''}}</span>
          </span>
          <span class="activity-content ellipsis">{{info.supports.length? info.supports[0].content : ''}}</span>
        </div>
      </div>
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showBrief">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showBrief = !showBrief">
    ...
    <div class="activity-sheet" v-show="showActivity">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="activeColor[item.type]" v-for="(item,index) in info.supports" :key="index">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="showActivity = !showActivity">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
